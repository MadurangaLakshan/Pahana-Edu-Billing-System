...
public class BillDAO {
	    ...
	    try (Connection conn = DBConnectionFactory.getConnection()) {
	        ...
	        try (PreparedStatement billStmt = conn.prepareStatement(billQuery, Statement.RETURN_GENERATED_KEYS);
	            ...
	            if (rs.next()) {
	                ...
	                // Set the generated ID back to the bill object
	...
	public Bill getBillById(String billId) {
	    // JOIN bill with customer table to get complete customer info
	    String billQuery = """
	    ...
	    try (Connection conn = DBConnectionFactory.getConnection()) {
	        ...
	        // Get bill with customer information
	        try (PreparedStatement billStmt = conn.prepareStatement(billQuery)) {
	            ...
	            if (billRs.next()) {
	                ...
	                // Now getting these from the joined customer table (c.*)
